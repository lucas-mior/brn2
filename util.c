...
static void
assert_integer_equal(char *file, uint32 line,
...
static void
assert_less_strings(char *file, uint32 line,
                     char *name1, char *name2, char *var1, char *var2) {
...
static void
assert_less_strings_equal(char *file, uint32 line,
                     char *name1, char *name2, char *var1, char *var2) {
    if (strcmp(var1, var2) > 0) {
        error("Assertion failed at %s:%u\n", file, line);
        error("%s = %s > %s = %s\n", name1, var1, var2, name2);
...
#define INTEGER_LESS_EQUAL(TYPE, FORMAT) \
    static void \
    assert_less_##TYPE##_equal(char *file, uint32 line, \
                             char *name1, char *name2, \
                             TYPE long long var1, TYPE long long var2) { \
    if (var1 > var2) { \
        error("Assertion failed at %s:%u\n", file, line); \
        error("%s = "FORMAT" > "FORMAT" = %s\n", name1, var1, var2, name2); \
        abort(); \
    } \
}
...
_Generic((VAR2), \
  short: assert_signed_equal(__FILE__, __LINE__, #VAR1, #VAR2, \
                             (llong)(VAR1), (llong)(VAR2)), \
  int: assert_signed_equal(__FILE__, __LINE__, #VAR1, #VAR2, \
                           (llong)(VAR1), (llong)(VAR2)), \
  long: assert_signed_equal(__FILE__, __LINE__, #VAR1, #VAR2, \
                            (llong)(VAR1), (llong)(VAR2)), \
  llong: assert_signed_equal(__FILE__, __LINE__, #VAR1, #VAR2, \
                            (llong)(VAR1), (llong)(VAR2)), \
...
_Generic((VAR2), \
  ushort: assert_unsigned_equal(__FILE__, __LINE__, #VAR1, #VAR2, \
                                (ullong)(VAR1), (ullong)(VAR2)), \
  uint: assert_unsigned_equal(__FILE__, __LINE__, #VAR1, #VAR2, \
                              (ullong)(VAR1), (ullong)(VAR2)), \
  ulong: assert_unsigned_equal(__FILE__, __LINE__, #VAR1, #VAR2, \
                               (ullong)(VAR1), (ullong)(VAR2)), \
  ullong: assert_unsigned_equal(__FILE__, __LINE__, #VAR1, #VAR2, \
                                (ullong)(VAR1), (ullong)(VAR2)), \
  default: assert(false) \
) \
