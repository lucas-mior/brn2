...
#define ASSERT_FIRST_IS_SIGNED(MODE, VAR1, VAR2, TYPE1, TYPE2) \
_Generic((VAR2), \
  schar:   ASSERT_BOTH_SIGNED(MODE,     VAR1, VAR2, TYPE1, TYPE2), \
  short:   ASSERT_BOTH_SIGNED(MODE,     VAR1, VAR2, TYPE1, TYPE2), \
  int:     ASSERT_BOTH_SIGNED(MODE,     VAR1, VAR2, TYPE1, TYPE2), \
  long:    ASSERT_BOTH_SIGNED(MODE,     VAR1, VAR2, TYPE1, TYPE2), \
  llong:   ASSERT_BOTH_SIGNED(MODE,     VAR1, VAR2, TYPE1, TYPE2), \
  uchar:   ASSERT_SIGNED_UNSIGNED(MODE, VAR1, VAR2, TYPE1, TYPE2), \
  ushort:  ASSERT_SIGNED_UNSIGNED(MODE, VAR1, VAR2, TYPE1, TYPE2), \
  uint:    ASSERT_SIGNED_UNSIGNED(MODE, VAR1, VAR2, TYPE1, TYPE2), \
  ulong:   ASSERT_SIGNED_UNSIGNED(MODE, VAR1, VAR2, TYPE1, TYPE2), \
  ullong:  ASSERT_SIGNED_UNSIGNED(MODE, VAR1, VAR2, TYPE1, TYPE2), \
  ldouble: ASSERT_BOTH_LDOUBLE(MODE,    VAR1, VAR2, TYPE1, TYPE2), \
  double:  ASSERT_BOTH_LDOUBLE(MODE,    VAR1, VAR2, TYPE1, TYPE2), \
  float:   ASSERT_BOTH_LDOUBLE(MODE,    VAR1, VAR2, TYPE1, TYPE2), \
...
#define ASSERT_FIRST_IS_UNSIGNED(MODE, VAR1, VAR2, TYPE1, TYPE2) \
_Generic((VAR2), \
  uchar:   ASSERT_BOTH_UNSIGNED(MODE,   VAR1, VAR2, TYPE1, TYPE2), \
  ushort:  ASSERT_BOTH_UNSIGNED(MODE,   VAR1, VAR2, TYPE1, TYPE2), \
  uint:    ASSERT_BOTH_UNSIGNED(MODE,   VAR1, VAR2, TYPE1, TYPE2), \
  ulong:   ASSERT_BOTH_UNSIGNED(MODE,   VAR1, VAR2, TYPE1, TYPE2), \
  ullong:  ASSERT_BOTH_UNSIGNED(MODE,   VAR1, VAR2, TYPE1, TYPE2), \
  schar:   ASSERT_UNSIGNED_SIGNED(MODE, VAR1, VAR2, TYPE1, TYPE2), \
  short:   ASSERT_UNSIGNED_SIGNED(MODE, VAR1, VAR2, TYPE1, TYPE2), \
  int:     ASSERT_UNSIGNED_SIGNED(MODE, VAR1, VAR2, TYPE1, TYPE2), \
  long:    ASSERT_UNSIGNED_SIGNED(MODE, VAR1, VAR2, TYPE1, TYPE2), \
  llong:   ASSERT_UNSIGNED_SIGNED(MODE, VAR1, VAR2, TYPE1, TYPE2), \
  ldouble: ASSERT_BOTH_LDOUBLE(MODE,    VAR1, VAR2, TYPE1, TYPE2), \
  double:  ASSERT_BOTH_LDOUBLE(MODE,    VAR1, VAR2, TYPE1, TYPE2), \
  float:   ASSERT_BOTH_LDOUBLE(MODE,    VAR1, VAR2, TYPE1, TYPE2), \
  default: unsupported_type_for_generic() \
...
#define ASSERT_FIRST_IS_LDOUBLE(MODE, VAR1, VAR2, TYPE1, TYPE2) \
_Generic((VAR2), \
  ldouble: ASSERT_BOTH_LDOUBLE(MODE, VAR1, VAR2, TYPE1, TYPE2), \
  double:  ASSERT_BOTH_LDOUBLE(MODE, VAR1, VAR2, TYPE1, TYPE2), \
  float:   ASSERT_BOTH_LDOUBLE(MODE, VAR1, VAR2, TYPE1, TYPE2), \
  schar:   ASSERT_BOTH_LDOUBLE(MODE, VAR1, VAR2, TYPE1, TYPE2), \
  short:   ASSERT_BOTH_LDOUBLE(MODE, VAR1, VAR2, TYPE1, TYPE2), \
  int:     ASSERT_BOTH_LDOUBLE(MODE, VAR1, VAR2, TYPE1, TYPE2), \
  long:    ASSERT_BOTH_LDOUBLE(MODE, VAR1, VAR2, TYPE1, TYPE2), \
  llong:   ASSERT_BOTH_LDOUBLE(MODE, VAR1, VAR2, TYPE1, TYPE2), \
  uchar:   ASSERT_BOTH_LDOUBLE(MODE, VAR1, VAR2, TYPE1, TYPE2), \
  ushort:  ASSERT_BOTH_LDOUBLE(MODE, VAR1, VAR2, TYPE1, TYPE2), \
  uint:    ASSERT_BOTH_LDOUBLE(MODE, VAR1, VAR2, TYPE1, TYPE2), \
  ulong:   ASSERT_BOTH_LDOUBLE(MODE, VAR1, VAR2, TYPE1, TYPE2), \
  ullong:  ASSERT_BOTH_LDOUBLE(MODE, VAR1, VAR2, TYPE1, TYPE2), \
  default: unsupported_type_for_generic() \
)
...
#define ASSERT_COMPARE(MODE, VAR1, VAR2, TYPE1, TYPE2) \
_Generic((VAR1), \
  char *: _Generic((VAR2), \
  ...
  schar:   ASSERT_FIRST_IS_SIGNED(MODE,   VAR1, VAR2, TYPE1, TYPE2), \
  short:   ASSERT_FIRST_IS_SIGNED(MODE,   VAR1, VAR2, TYPE1, TYPE2), \
  int:     ASSERT_FIRST_IS_SIGNED(MODE,   VAR1, VAR2, TYPE1, TYPE2), \
  long:    ASSERT_FIRST_IS_SIGNED(MODE,   VAR1, VAR2, TYPE1, TYPE2), \
  llong:   ASSERT_FIRST_IS_SIGNED(MODE,   VAR1, VAR2, TYPE1, TYPE2), \
  uchar:   ASSERT_FIRST_IS_UNSIGNED(MODE, VAR1, VAR2, TYPE1, TYPE2), \
  ushort:  ASSERT_FIRST_IS_UNSIGNED(MODE, VAR1, VAR2, TYPE1, TYPE2), \
  uint:    ASSERT_FIRST_IS_UNSIGNED(MODE, VAR1, VAR2, TYPE1, TYPE2), \
  ulong:   ASSERT_FIRST_IS_UNSIGNED(MODE, VAR1, VAR2, TYPE1, TYPE2), \
  ullong:  ASSERT_FIRST_IS_UNSIGNED(MODE, VAR1, VAR2, TYPE1, TYPE2), \
  ldouble: ASSERT_FIRST_IS_LDOUBLE(MODE,  VAR1, VAR2, TYPE1, TYPE2), \
  double:  ASSERT_FIRST_IS_LDOUBLE(MODE,  VAR1, VAR2, TYPE1, TYPE2), \
  float:   ASSERT_FIRST_IS_LDOUBLE(MODE,  VAR1, VAR2, TYPE1, TYPE2) \
)

#define ASSERT_EQUAL(VAR1, VAR2) \
        ASSERT_COMPARE(equal,      VAR1, VAR2, TYPENAME(VAR1), TYPENAME(VAR2))
#define ASSERT_NOT_EQUAL(VAR1, VAR2) \
        ASSERT_COMPARE(not_equal,  VAR1, VAR2, TYPENAME(VAR1), TYPENAME(VAR2))
#define ASSERT_LESS(VAR1, VAR2) \
        ASSERT_COMPARE(less,       VAR1, VAR2, TYPENAME(VAR1), TYPENAME(VAR2))
#define ASSERT_LESS_EQUAL(VAR1, VAR2) \
        ASSERT_COMPARE(less_equal, VAR1, VAR2, TYPENAME(VAR1), TYPENAME(VAR2))
#define ASSERT_MORE(VAR1, VAR2) \
        ASSERT_COMPARE(more,       VAR1, VAR2, TYPENAME(VAR1), TYPENAME(VAR2))
#define ASSERT_MORE_EQUAL(VAR1, VAR2) \
        ASSERT_COMPARE(more_equal, VAR1, VAR2, TYPENAME(VAR1), TYPENAME(VAR2))
