...
main(void) {
    ...
    ASSERT_EQUAL(TEST_FLAGS_parse("TEST_FLAGS_READ"), TEST_FLAGS_READ);
    ASSERT_EQUAL(TEST_FLAGS_parse("TEST_FLAGS_READ | TEST_FLAGS_EXEC"),
                 TEST_FLAGS_READ | TEST_FLAGS_EXEC);
    ASSERT_EQUAL(TEST_FLAGS_parse("READ|WRITE"),
                 TEST_FLAGS_READ | TEST_FLAGS_WRITE);
    ASSERT_EQUAL(TEST_FLAGS_parse("NONE"), TEST_FLAGS_NONE);
    ...
    ASSERT_EQUAL(TEST_NORMAL_parse("TEST_NORMAL_APPLE"), TEST_NORMAL_APPLE);
    ASSERT_EQUAL(TEST_NORMAL_parse("BANANA"), TEST_NORMAL_BANANA);
    ASSERT_EQUAL(TEST_NORMAL_parse("TEST_NORMAL_CHERRY"), TEST_NORMAL_CHERRY);
