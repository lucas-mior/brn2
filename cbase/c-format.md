...
- Space is mandatory around `=` used for assignment.
...
```c
// bad
void my_function(MyStruct *, int32, int32);

// bad
void my_function(MyStruct *struct, int32 x, int32 y);

// good
void my_function(MyStruct *, int32 x, int32 y);
```
