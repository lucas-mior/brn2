...
static uint32 hash_function(char *, uint32);
static uint32 hash_normal(void *, uint32);
...
static bool hash_map_insert(HashMap *, char *, uint32, uint32);
bool hash_map_insert_pre_calc(HashMap *, char *, uint32, uint32, uint32);
static void *hash_map_lookup(HashMap *, char *, uint32);
void *hash_map_lookup_pre_calc(HashMap *, char *, uint32, uint32);
static bool hash_map_remove(HashMap *, char *, uint32);
...
static bool hash_set_insert(HashSet *, char *, uint32, uint32);
bool hash_set_insert_pre_calc(HashSet *, char *, uint32, uint32, uint32);
static void *hash_set_lookup(HashSet *, char *, uint32);
void *hash_set_lookup_pre_calc(HashSet *, char *, uint32, uint32);
static bool hash_set_remove(HashSet *, char *, uint32);
